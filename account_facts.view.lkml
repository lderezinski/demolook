include: "operations.model.lkml"

view: account_facts {
  derived_table: {
    explore_source: dailyspend {
      column: account_number {field: dailyspend.accountnumber}
      column: total_orders {field: dailyspend.count}
      column: total_spend {field: dailyspend.sum_spend}
      column: avg_spend {field: dailyspend.avg_spend}
      }
    }
...
#### Comparitor logic ####
  filter: account_select {
    ...
    suggest_explore: zcustomers
    suggest_dimension: zcustomers.accountnumber
  }
